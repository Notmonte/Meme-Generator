...
const Meme =()=> {
    ...
    const getMeme =()=> {
        const memes = allMemes.data.memes  // Selecting objects from the memes array in memesData.js
        ...
        <section className="section meme-section">
            <div className="container">
                ...
                <div className="meme-img-div">
                    <img src={meme.randomImage} alt="get meme image" className="img-fluid image d-block mx-auto"/>
